...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Start typing animation
  const summaryText = "Cybersecurity enthusiast with a strong interest in SOC operations and security monitoring, supported by a solid foundation in computer networks and core security principles. Demonstrates an analytical and structured approach to problem-solving while gaining hands-on experience through labs and simulations. Interested in Java and database technologies, with a commitment to continuous learning in cybersecurity and software development";
